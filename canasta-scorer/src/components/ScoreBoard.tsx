...
export function ScoreBoard({
  ...
  const activeRules = houseRules ?? DEFAULT_HOUSE_RULES;
  ...
  return (
    <>
          ...
          <div className="max-w-lg mx-auto px-4 pt-4 pb-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              {teamNames.map((name, i) => {
                ...
                const meld = getMinimumMeld(score, activeRules);
            ...
            {/* Gap indicator + hand info + rules button */}
      ...
      {showRulesModal && (
        <RulesModal rules={activeRules} onClose={() => setShowRulesModal(false)} />
      )}
    </>
  );
}
